  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-end justify-between gap-4 border-b border-ink-100 pb-5">
        <div><p className="page-eyebrow mb-1">Operations / Attendance</p><h1 className="page-title">{isAdmin ? "Admin attendance review" : "My time & leave"}</h1><p className="page-subtitle">{isAdmin ? "Review team work-time and leave requests from one place." : "Log every kind of work, request leave, and keep approvals in one place."}</p></div>
      ...
      <div className="rounded-xl border border-primary/10 bg-primary-soft/50 px-4 py-3 text-sm text-primary-dark"><span className="font-semibold">Private payroll:</span> {isAdmin ? "Admin accounts are review-only: personal work time and leave requests cannot be submitted. Use the approval queue to review your team." : "your hours and leave requests are visible to the assigned manager and admin for approval."} Salary totals are available only in the admin Payroll workspace.</div>
